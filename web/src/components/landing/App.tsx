...
export default () => (
    <RandomGraphicElement elements={5}>
        <div className="app-section" id="the-app">
            ...
            <h4 data-aos="fade-up" data-aos-duration="2000">Demo</h4>
            <h2 data-aos="fade-up" data-aos-duration="2000">The App</h2>

            <div className="content-wrapper">
                <img data-aos="fade-right" data-aos-duration="2000" src={app} alt="App" className="desktop" />
                <img data-aos="fade-right" data-aos-duration="2000" src={appMobile} alt="App" className="mobile" />
                <div className="content-list">
                    <div className="content-item" data-aos="fade-left" data-aos-duration="2000">
