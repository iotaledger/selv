...
export default () => (
    <RandomGraphicElement elements={10}>
        <div className='benefits-section' id='benefits'>
            <h4 data-aos='fade-up' data-aos-duration='1000'>Benefits</h4>
            <h2 data-aos='fade-up' data-aos-duration='1000'>For users</h2>
            ...
            <h4 data-aos='fade-up' data-aos-duration='1000'>Benefits</h4>
            <h2 data-aos='fade-up' data-aos-duration='1000'>For business</h2>
            <div className='benefits-wrapper'>
                <div className='benefit' data-aos='fade-up' data-aos-duration='1000'>
